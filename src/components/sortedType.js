...
export const btnDataList = [
    {btnId:1, icon:Icon_name, btnText:"이름 순"},
    {btnId:2, icon:Icon_rate, btnText:"별점 순"},
    {btnId:3, icon:Icon_review, btnText:"리뷰 개수"}
] 


function BtnList({props, selectedType, setSelectedType}) {
